 ...
 * MIT licensed
 */
window.conditionizr=function(a,b,c){"use strict";var d,e={},f=b.head||b.getElementsByTagName("head")[0];f.appendChild(document.createTextNode('<!--[if IE]><![endif]-->'));var g=function(a,c,g){var h=(g?"":d||"")+a+("script"===c?".js":".css");if(g||e[a])switch(c){case"script":var i=b.createElement("script");i.src=h,f.appendChild(i);break;case"style":var j=b.createElement("link");j.href=h,j.rel="stylesheet",f.appendChild(j);break;case"class":b.documentElement.className+=" "+a}};return e.on=function(a,b){var c=a.toLowerCase(),d=/^!/;if(d.test(c)){var f=c.replace(d,"");e[f]||b()}e[c]&&b&&b()},e.add=function(a,b,d){var f=a.toLowerCase();if(e[f]!==c)throw new Error("Test "+f+" already exists");if(d||(d=b),e[f]=d(),!(b instanceof Array))throw new Error("Dependencies must be an array");for(var h=0;h<b.length;h++){var i=b[h];g(f,i)}},e.config=function(a){var b=a||{};d=b.assets||"";var c=b.tests;for(var e in c)for(var f=c[e],h=0;h<f.length;h++){var i=f[h];g(e,i)}},e.load=e.polyfill=function(a,b){for(var c=/\.js$/.test(a)?"script":"style",d=a.replace(/\.(js|css)$/,""),f=0;f<b.length;f++)e[b[f]]&&g(d,c,!0)},e}(window,document);
